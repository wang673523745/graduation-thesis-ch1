...
data_name="RoadScene_train"
img_size=128   #patch size
stride=200     #patch stride

IR_files = sorted(get_img_file(r"RoadScene_train/ir"))
VIS_files   = sorted(get_img_file(r"RoadScene_train/vi"))

assert len(IR_files) == len(VIS_files)

h5f = h5py.File(os.path.join('.\\data', #创建h5文件
